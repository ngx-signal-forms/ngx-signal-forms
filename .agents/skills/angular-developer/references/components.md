...
- **Component Naming**: Do not add the `Component` suffix to Component class names (e.g., `AppComponent`) unless the project has been configured to use that naming convention.
