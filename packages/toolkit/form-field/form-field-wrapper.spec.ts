...
describe('NgxSignalFormWrapperComponent', () => {
  describe('Field name generation', () => {
    ...
    it('should generate different unique IDs for multiple components without explicit fieldName', async () => {
      ...
      const { container } = await render(
        `<div>
          <ngx-form-field-wrapper [formField]="field1">
            <input id="input1" type="text" />
          </ngx-form-field-wrapper>
          <ngx-form-field-wrapper [formField]="field2">
            <input id="input2" type="text" />
          </ngx-form-field-wrapper>
          <ngx-form-field-wrapper [formField]="field3">
    ...
    it('should allow mixing explicit and auto-derived fieldNames', async () => {
      ...
      const { container } = await render(
        `<div>
          <ngx-form-field-wrapper [formField]="field1" fieldName="email">
            <input id="email" type="email" />
          </ngx-form-field-wrapper>
          <ngx-form-field-wrapper [formField]="field2">
            <input id="password" type="password" />
          </ngx-form-field-wrapper>
          <ngx-form-field-wrapper [formField]="field3" fieldName="confirm">
    ...
    it('should clear stale projected control metadata when a custom control loses its id', async () => {
      ...
      @Component({
        template: `
          <ngx-form-field-wrapper [formField]="field" fieldName="rating">
  ...
  describe('Auto-resolution of field names from input elements', () => {
    ...
    it('renders messages above the control when errorPlacement is top', async () => {
      ...
      const { container } = await render(
        `<ngx-form-field-wrapper [formField]="field" errorPlacement="top">
  ...
  describe('Field marking configuration', () => {
    it("marks required fields by default ('required' mode), in standard appearance", async () => {
      const { container } = await render(
        `<ngx-form-field-wrapper [formField]="field">
          <label for="email">Email</label>
    ...
    it("marks required fields in outline appearance too ('required' mode)", async () => {
      const { container } = await render(
    ...
    it("does not mark a non-required field in 'required' mode", async () => {
      const { container } = await render(
        `<ngx-form-field-wrapper [formField]="field">
    ...
    it("renders nothing in 'none' mode even for a required field", async () => {
      const { container } = await render(
        `<ngx-form-field-wrapper [formField]="field" showMarkerWhen="none">
          <label for="email">Email</label>
          <input id="email" type="email" required />
        </ngx-form-field-wrapper>`,
        {
    ...
    it("marks the OPTIONAL (non-required) field in 'optional' mode", async () => {
      const { container } = await render(
    ...
    it("does NOT mark a required field in 'optional' mode", async () => {
      const { container } = await render(
        `<ngx-form-field-wrapper [formField]="field" showMarkerWhen="optional">
          <label for="email">Email</label>
          <input id="email" type="email" required />
    ...
    it('uses a custom required marker when provided', async () => {
      const { container } = await render(
        `<ngx-form-field-wrapper [formField]="field" requiredMarker="(required)">
          <label for="email">Email</label>
          <input id="email" type="email" required />
        </ngx-form-field-wrapper>`,
        {
    ...
    it('uses a custom optional marker when provided', async () => {
      const { container } = await render(
        `<ngx-form-field-wrapper
          [formField]="field"
    ...
    it('marks the marker as aria-hidden so screen readers do not double-announce', async () => {
      // Auto-aria already writes `aria-required="true"` to the bound control,
      // and screen readers announce that. The visual marker MUST be hidden
  ...
  describe('Error display', () => {
    ...
    it('should display errors WITHOUT [formRoot] context for on-touch strategy', async () => {
       ...
       *
       * This means users can use <ngx-form-field-wrapper> for simple forms without
      ...
      await render(
        `<ngx-form-field-wrapper [formField]="field" fieldName="email">
          <label for="email">Email</label>
          <input id="email" type="email" />
        </ngx-form-field-wrapper>`,
        {
  ...
  describe('Warning Display', () => {
    ...
    it('should handle edge case of error without kind property', async () => {
      ...
      const { container } = await render(
        `<ngx-form-field-wrapper [formField]="field" fieldName="test">
          <label for="test">Test</label>
          <input id="test" type="text" />
        </ngx-form-field-wrapper>`,
        {
    ...
    it('should apply warning class when warnings are present from start (no blocking errors)', async () => {
      ...
      const { container } = await render(
        `<ngx-form-field-wrapper [formField]="field" fieldName="dynamic">
  ...
  describe('Custom control support (FormValueControl pattern)', () => {
    ...
    it('should not resolve nested ngx-form-field-wrapper as custom control', async () => {
      const invalidField = signal({
        invalid: () => true,
        touched: () => true,
        errors: () => [{ kind: 'required', message: 'Required' }],
    ...
    it('should allow explicit fieldName to override custom control id', async () => {
      ...
      const { container } = await render(
        `<ngx-form-field-wrapper [formField]="field" fieldName="explicit-name">
  ...
  describe('DI Context Provider (NGX_SIGNAL_FORM_FIELD_CONTEXT)', () => {
    it('should provide field context to child components via DI', async () => {
       ...
       * - NgxFormFieldWrapper isn't defined yet at that point
    ...
    it('should allow explicit fieldName to override context', async () => {
      ...
      const { container } = await render(
        `<ngx-form-field-wrapper [formField]="field" fieldName="custom-override">
          <label for="email">Email</label>
          <input id="email" type="email" />
        </ngx-form-field-wrapper>`,
        {
  ...
  describe('Appearance input', () => {
    describe('Standard appearance', () => {
      ...
      it('should use standard appearance when explicitly set', async () => {
        const { container } = await render(
          `<ngx-form-field-wrapper [formField]="field" appearance="standard">
            <label for="email">Email</label>
            <input id="email" type="email" />
          </ngx-form-field-wrapper>`,
          {
    ...
    describe('Inherit appearance', () => {
      it('should inherit outline from global config', async () => {
        const { container } = await render(
          `<ngx-form-field-wrapper [formField]="field" appearance="inherit">
            <label for="email">Email</label>
            <input id="email" type="email" />
          </ngx-form-field-wrapper>`,
          {
    ...
    describe('Required marker with appearance', () => {
      ...
      it('should also show required marker with standard appearance', async () => {
        // Markers are no longer outline-only: in 'required' mode (the default)
        // the marker renders in standard appearance too.
        const { container } = await render(
          `<ngx-form-field-wrapper [formField]="field" appearance="standard">
            <label for="email">Email</label>
            <input id="email" type="email" required />
  ...
  describe('hidden() field behavior', () => {
    ...
    it('should treat fields without a hidden() method as visible', async () => {
      ...
      const { container } = await render(
        `<ngx-form-field-wrapper [formField]="field" fieldName="legacy">
