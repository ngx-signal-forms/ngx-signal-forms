...
import { NgxSignalForm } from './ngx-signal-form';
...
/**
 * Test suite for NgxSignalForm ([formRoot]).
 *
 * **Testing Philosophy:**
  ...
  describe('Form context provision', () => {
    it('should provide form context to child components', async () => {
      @Component({
        ...
        imports: [FormRoot, NgxSignalForm, ContextDisplayComponent],
        template: `
  ...
  describe('Submission state tracking (user-facing behavior)', () => {
    ...
    it('should track submission lifecycle with submit() helper', async () => {
      @Component({
        ...
        imports: [FormField, FormRoot, NgxSignalForm, ContextDisplayComponent],
        template: `
          <form
            [formRoot]="contactForm"
            ngxSignalForm
