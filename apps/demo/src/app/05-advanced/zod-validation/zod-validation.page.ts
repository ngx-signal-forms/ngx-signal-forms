...
import { ZOD_VALIDATION_CONTENT } from './zod-validation.content';
...
export class ZodValidationPage {
  ...
  protected readonly content = ZOD_VALIDATION_CONTENT;
  protected readonly formRef = viewChild(ZodValidationComponent);
}
