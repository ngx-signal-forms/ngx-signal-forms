...
| Wrap sliders / third-party widgets   | `/form-field` + `ngxSignalFormControl="slider"` + `appearance="plain"`             | [`custom-controls`](./apps/demo/src/app/04-form-field-wrapper/custom-controls)                                                                             |
