...
description: 'Use this agent when you need to create automated browser tests
  ...
  ordinal like "Multiplication tests" --></test-suite> <test-name><!-- Name of the test case without the ordinal like "should add two numbers"
